        ...
        <div className="w-1/2 flex flex-col relative border-r border-gray-200">
            <div className="flex-1 relative bg-gradient-to-br from-blue-950 via-slate-900 to-blue-950">
                ...
                <div className="relative z-10 text-center pointer-events-none mt-20">
                    <h2 className="text-3xl font-bold text-white drop-shadow-[0_0_10px_rgba(59,130,246,0.8)]">MARY AI</h2>
            ...
            <div className="bg-white p-4 border-t border-gray-200 flex justify-between items-center z-20">
                <p className="text-[10px] text-gray-600 italic">Sistema Inteligente de Respuesta Académica</p>
        ...
        <div className="w-1/2 flex flex-col bg-white relative z-10 shadow-2xl">
           <div className="flex-1 overflow-y-auto p-4 space-y-6 scroll-smooth">
             ...
             {messages.map((msg, i) => (
               <div key={i} className={`flex ${msg.role === 'user' ? 'justify-end' : 'justify-start'}`}>
                 <div className={`max-w-md p-4 rounded-2xl shadow-sm ${msg.role === 'user' ? 'bg-blue-600 text-white rounded-br-none' : 'bg-white text-gray-800 border border-gray-200 rounded-bl-none'}`}>
           ...
           <div className="bg-white/95 backdrop-blur-md p-4 border-t border-gray-100 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
             <div className="flex gap-3">
               ...
               <input type="text" value={input} onChange={(e) => setInput(e.target.value)} onKeyPress={(e) => e.key === 'Enter' && handleSubmit()} placeholder="Escribe o habla aquí..." className="flex-1 p-4 bg-gray-50 border border-gray-200 rounded-full focus:ring-2 focus:ring-blue-500 outline-none text-gray-800 placeholder-gray-400 shadow-inner" disabled={isLoading}/>
               <button onClick={() => handleSubmit()} disabled={!input.trim() || isLoading} className="p-4 bg-blue-600 text-white rounded-full hover:bg-blue-700 transition disabled:bg-gray-300 transform active:scale-95 shadow-md"><Send className="w-5 h-5" /></button>
             </div>
