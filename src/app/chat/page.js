  ...
  export default function ChatPage() {
    ...
    // <--- 2. CREAMOS LA REFERENCIA (EL ANCLA)
    const messagesEndRef = useRef(null)

    // <--- 3. FUNCIÓN PARA BAJAR AUTOMÁTICAMENTE
    const scrollToBottom = () => {
      messagesEndRef.current?.scrollIntoView({ behavior: "smooth" })
    }

    // <--- 4. EFECTO: SE EJECUTA CUANDO CAMBIAN LOS MENSAJES O SI ESTÁ ESCRIBIENDO
    useEffect(() => {
      scrollToBottom()
    }, [messages, isTyping])
    ...
    return (
      <div className="flex flex-col h-screen bg-gradient-to-br from-blue-50 to-blue-100 font-sans">
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-6 scroll-smooth">
          ...
          {/* <--- 5. COLOCAMOS EL DIV INVISIBLE AQUÍ AL FINAL DE LA LISTA */}
